...
<!-- //breadcrumbs -->
	...
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head"><span> LogIn</span></h3>
			...
			?>
						<form action="login_action.php" method="post">
							<span>
								<i>User Name</i>
								<input type="text" name="log_username" placeholder=" " required="">
							</span>
							<span>
								<i>Password</i>
								<input type="text" name="log_password" placeholder=" " required="">
                 				</span>
							<span>
     ...
     <i> User Type</i>
      ...
      <option value="user">USER</option>
							...
							<div class="w3_submit">
								<input type="submit" value="Submit Now" name="login">
							</div>
						</form>
					</div>
				</div>
