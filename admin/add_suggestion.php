...
<!-- //breadcrumbs -->
	...
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head"><span>Suggestions</span></h3>
				...
				<div class="col-md-12 w3_agile_mail_left">
					<div class="agileits_mail_grid_right1 agile_mail_grid_right1">
						<form action="#" method="post">
							<span>
								<i>Suggestions</i>
								<textarea name ="sug_message" placeholder="Enter Your Suggestions" required="required" pattern="[a-zA-Z\s]+"></textarea> 
							</span>
