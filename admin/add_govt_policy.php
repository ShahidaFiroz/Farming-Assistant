...
<!-- //breadcrumbs -->
	...
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head"><span>Policies</span></h3>
			...
			<div class="w3ls_news_grids">
				<div class="col-md-12 w3_agile_mail_left">
					<div class="agileits_mail_grid_right1 agile_mail_grid_right1">
						...
						<?php
				if(isset($_SESSION['add_policy_msg']))
				{
					echo $_SESSION['add_policy_msg'];
					unset($_SESSION['add_policy_msg']);
				}

				
			?>

						<form action="add_govt_policy_action.php" method="post" enctype="multipart/form-data">
							<span>
								<i>Policy Name</i>
								<input type="text" name="pol_name" placeholder=" " required="">
							</span>
							<span>
								<i>Policy Description</i>
								<textarea name ="pol_description" placeholder=" " required="required" pattern="[a-zA-Z\s]+"></textarea>
                 				</span>
													
                                 <span>
								<i>Policy File</i>
								<input type="file" name="pol_file" placeholder=" " required="">
							</span>
							<div class="w3_submit">
