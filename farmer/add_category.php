		...
		<div class="container">
			...
			?>
						<form action="add_category_action.php" method="post">
							<span>
								<i>Category Name</i>
								<input type="text" name="cat_name" placeholder=" " required="">
							</span>
							<span>
								<i>Category Description</i>
								<input type="text" name="cat_description" placeholder=" " required="">
                 				</span>
													
   
							<div class="w3_submit">
								<input type="submit" value="Submit Now" name="category">
							</div>
						</form>
					</div>
				</div>
