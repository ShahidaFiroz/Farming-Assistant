				...
				<div class="agile_social_icons_banner">
					<ul class="agileits_social_list">
						<li><a href="index.php">Home</a></li>
									<div class="dropdown">
										<a href="#" data_toggle="dropdown">Add</a>
										<ul >
									...
									<li><a href="add_complaint.php">Complaint</a></li> 
                                   <li><a href="gallery.php">Policy</a></li> 
                                    <li><a href="view_catagory.php">view Category</a></li> 
                                    <li><a href="view_product.php">view Products</a></li>
                                    <li><a href="view_instruction.php">view Instruction</a></li>
