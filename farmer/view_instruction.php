...
$Products=array();
$products=$farmer->view_instruction($reg_id);
    ...
    <div class="container">
      <div class="w3layouts_breadcrumbs_left">
        <ul>
          ...
          <li><i class="fa fa-info-circle" aria-hidden="true"></i>Instructions</li>
        </ul>
      </div>
...
<?php
   ...
   ?>
   <?php
if (isset($_SESSION["delete_ins"])) 
   {
?>
<div class="alert alert-success" role="alert">
          <strong>Well done!</strong>
    <?php
   echo $_SESSION["delete_ins"];
   unset($_SESSION["delete_ins"]);
   ?>
   </div>
