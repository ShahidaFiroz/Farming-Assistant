...
<!-- //breadcrumbs -->
	...
	<div class="welcome">
		<div class="container">
			...
			?>
						<form action="add_instruction_action.php" method="post">
							

							    <span>
								<i>Growing Period</i>
								<input type="text" name="ins_growing_period" placeholder=" " required="">
                 				<!-- </span>
                 				<span>
								...
								<span>
								<i>Fertiliser</i>
								<input type="text" name="ins_fertiliser" placeholder=" " required="">
                 				</span>
                 				<span>
								<i>Description</i>
								<textarea name ="ins_description" placeholder=" " required="required" pattern="[a-zA-Z\s]+"></textarea>
                 				</span>
							
							<input type="hidden" value="<?php echo $item_id; ?>" name="item_id">
						<div class="w3_submit">
								<input type="submit" value="Submit Now" name="Instructions">
							</div>
