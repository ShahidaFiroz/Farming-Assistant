...
<!-- //breadcrumbs -->
	...
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head"><span> Products</span> </h3>
			...
			?>
						<form action="add_product_action.php" method="post" enctype="multipart/form-data">
							...
							<span>
								<i>Product Code</i>
								<input type="text" name="item_code" placeholder=" " required="">
                 				</span>
								<span>
								<i>Product Price</i>
								...
								<input type="text" name="item_qty" placeholder=" " required="">
                 				</span>		
                 				 <span>
								<i>Upload Product Pic</i>
								<input type="file" name="upload_file" placeholder=" " required="">
                 				</span>		
                 						
							<div class="w3_submit">
								<input type="submit" value="Submit Now" name="Products">
							</div>
						</form>
					</div>
				</div>
